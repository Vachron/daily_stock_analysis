...
import { BarChart3, BriefcaseBusiness, Crosshair, Home, LogOut, MessageSquareQuote, Settings2, Target } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'screener', label: '选股', to: '/screener', icon: Crosshair },
  { key: 'backtest', label: '回测', to: '/backtest', icon: BarChart3 },
  { key: 'alpha', label: 'Alpha', to: '/alpha', icon: Target },
